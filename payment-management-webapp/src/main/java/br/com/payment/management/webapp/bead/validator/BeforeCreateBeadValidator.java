...
/**
 * Validator responsible for performing custom validations before creating a {@link Bead}.
 *
 * @author William Custodio
 */
@Component("beforeCreateBeadValidator")
public class BeforeCreateBeadValidator implements Validator {
    ...
    public void validate(final Object target, final Errors errors) {
        this.beadServiceValidator.validateBeforeCreate((Bead) target);
    }
}